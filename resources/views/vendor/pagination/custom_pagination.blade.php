            ...
            <div class="pagination-container">
                <ul class="list-inline list-unstyled">
                    ...
                    @if ($paginator->hasMorePages())
                        <li class="next">
                            <a href="{{ $paginator->nextPageUrl() }}" rel="next" aria-label="@lang('pagination.next')">&rsaquo;<i class="fa fa-angle-right"></i></a>
                        </li>
                    @else
                        <li class="next disabled" aria-disabled="true" aria-label="@lang('pagination.next')">
                            <span aria-hidden="true"><a href="#"><i class="fa fa-angle-right"></i></a></span>
                        </li>
                    @endif
