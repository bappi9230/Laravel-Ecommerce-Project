                ...
                <div class="col-12">
                    ...
                    <div class="box">
                        <div class="box-header with-border">
                            ...
                            <a href="{{ route('add.admin.user') }}" class="btn btn-primary" style="float: right;">Add Admin User</a>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @foreach($adminuser as $item)
                                        <tr>
                                            <td> <img style="width: 50px; height: 50px;" src="{{ asset($item->profile_photo_path) }}">  </td>
                                            <td> {{ $item->name }}  </td>
                                            <td> {{ $item->email  }}  </td>
                                            ...
                                            <td width="25%">
                                                ...
                                                <a href="{{ route('delete.admin.user',$item->id) }}" class="btn btn-danger" title="Delete">
