                    ...
                    <li>
                      <div class="yamm-content ">
                        <div class="row">
                          ...
                          <div class="col-xs-12 col-sm-6 col-md-4 col-menu banner-image"> <img class="img-responsive" src="{{ asset('frontend/ssets/images/banners/top-menu-banner.jpg') }}a" alt=""> </div>
                          <!-- /.yamm-content -->
                        </div>
                      </div>
                    </li>
