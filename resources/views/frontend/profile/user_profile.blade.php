    ...
    <div class="container">
        <div class="row">
            <div class="col-md-2"><br><br>
                <img class="card-img-top" style="border-radius: 50%; width: 100%;height: 100%;" src="{{ (!empty($userData->profile_photo_path))? url('upload/user_profile_image/'.$userData->profile_photo_path): url('upload/no_image.jpg') }}" alt="image"><br><br>
