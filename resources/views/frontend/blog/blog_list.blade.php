                ...
                <div class="blog-page">
                    <div class="col-md-9">
                        ...
                        <div class="blog-post  wow fadeInUp">
                            ...
                            <p>@if(session()->get('language') == 'bangla') {!! Str::limit($post->post_details_bn, 200 )  !!} @else {!! Str::limit($post->post_details_en, 200 )  !!} @endif</p>
                                    ...
                                    @foreach($blogcategory as $category)
                                        <ul class="list-group">
                                            <a href="{{ url('blog/category/post/'.$category->id) }}">
                                                <li class="list-group-item">@if(session()->get('language') == 'hindi') {{ $category->blog_category_name_bn }} @else {{ $category->blog_category_name_en }} @endif</li>
                                            </a>
                                        </ul>
                                    @endforeach
