							 ...
							 <form method="POST" action="{{ isset($guard) ? url($guard.'/login') : route('login') }}">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="email" name="email" id="email" :value="old('email')" required class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Admin Email">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="password" id="password" name="password" required class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Admin Password">
									</div>
								</div>
								  <div class="row">
									<div class="col-6">
