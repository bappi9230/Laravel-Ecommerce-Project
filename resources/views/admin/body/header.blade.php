 <header class="main-header" >
    <!-- Header Navbar -->
    <nav class="navbar navbar-static-top pl-30" style="background-color:white !important">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
			<a href="#" class="waves-effect waves-light rounded dropdown-toggle p-0" data-toggle="dropdown" title="User">
				<img src="{{ (!empty($adminData->profile_photo_path))? asset($adminData->profile_photo_path) : url('upload/no_image.jpg') }}" alt="">
			</a>
